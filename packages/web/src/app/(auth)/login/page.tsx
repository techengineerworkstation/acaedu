      ...
      >
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="mt-6 text-xl font-semibold text-[var(--color-text-primary)] dark:text-white">
              Welcome Back
            </h2>
            ...
            <button
              ...
              className={`flex-1 py-2.5 text-sm font-medium rounded-lg transition-all ${
                loginMethod === 'password'
                  ? 'bg-white dark:bg-gray-600 text-[var(--color-text-primary)] dark:text-white shadow-sm'
                  : 'text-gray-600 dark:text-gray-300 hover:text-[var(--color-text-primary)] dark:hover:text-white'
              }`}
            >
              Password
            </button>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-all pr-12"
                    required
                    disabled={isLoading}
                  />
                  <button
