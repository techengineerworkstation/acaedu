...
export default function LecturerCourseDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'materials' | 'schedule' | 'enrollments'>('overview');
              ...
              <div className="space-y-3">
                {enrollments.map((enrollment) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-medium text-gray-900">{enrollment.student?.full_name || 'Unknown User'}</h4>
                      <p className="text-sm text-gray-500 mt-1">
                    ...
                    <div className="flex items-center space-x-3 mt-2 text-sm">
                      ...
                      >
                        {enrollment.status === 'active' ? 'Unenroll' : 'Unenrolled'}
                      </Button>
                    </div>
                  </div>
                ))}
