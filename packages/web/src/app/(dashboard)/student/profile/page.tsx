...
import { CameraIcon, UserIcon, EnvelopeIcon, PhoneIcon, MapPinIcon, IdentificationIcon, CalendarIcon } from '@heroicons/react/24/outline';
            ...
            {editing ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea value={form.bio} onChange={(e) => setForm({ ...form, bio: e.target.value })} rows={3} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500" placeholder="Tell us about yourself..." />
                </div>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div><span className="text-sm text-gray-500">Level</span><p className="font-medium text-gray-900">{(user as any)?.level || 'Not set'}</p></div>
