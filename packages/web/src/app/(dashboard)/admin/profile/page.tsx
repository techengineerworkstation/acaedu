...
import { CameraIcon, UserIcon, EnvelopeIcon, PhoneIcon, ShieldCheckIcon, IdentificationIcon } from '@heroicons/react/24/outline';
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center space-x-6">
              <div className="relative">
                {form.avatar_url ? (
                  ...
                  <div className="h-24 w-24 rounded-full bg-primary-100 flex items-center justify-center">
                    <span className="text-2xl font-bold text-primary-700">{form.full_name?.charAt(0) || '?'}</span>
                  </div>
                )}
              ...
              <div>
                ...
                <span className="inline-flex items-center mt-2 px-3 py-1 bg-primary-100 text-primary-700 rounded-full text-sm capitalize">
        ...
        <ScrollReveal animation="slide" direction="up" delay={0.1}>
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
              <ShieldCheckIcon className="h-5 w-5 mr-2" /> Admin Information
            </h3>
            {editing ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea value={form.bio} onChange={(e) => setForm({ ...form, bio: e.target.value })} rows={3} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500" placeholder="Your bio..." />
                </div>
              </div>
            ) : (
