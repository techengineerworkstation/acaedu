      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <Card className="p-6 space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Manage admin paywall and account access restrictions.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
              <div>
                <p className="font-medium text-gray-900">Admin Paywall</p>
                <p className="text-sm text-gray-500">
                  When enabled, new admin accounts must pay before activation.
                  Only whitelisted emails can toggle this setting.
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>Allowed Admin Emails:</strong> danielebirim25@gmail.com, chidexibe@gmx.com, merchantenterpriseconnect@yahoo.com
              </p>
              <p className="text-xs text-blue-600 mt-1">
                These emails are whitelisted for admin registration and can always access the app.
              </p>
            </div>
          </div>
        </Card>
