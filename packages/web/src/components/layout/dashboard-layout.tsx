...
const roleConfig = {
  student: {
    ...
    navItems: [
      ...
      { href: '/student/lectures', label: 'Class Records', icon: VideoCameraIcon },
      ...
      { href: '/student/tests', label: 'Tests', icon: ClipboardDocumentListIcon },
  ...
  lecturer: {
    ...
    navItems: [
      ...
      { href: '/lecturer/tests', label: 'Tests', icon: ClipboardDocumentListIcon },
      { href: '/lecturer/assignments', label: 'Assignments', icon: DocumentTextIcon },
      { href: '/lecturer/grades', label: 'Grades', icon: AcademicCapIcon },
      { href: '/lecturer/videos', label: 'Class Records', icon: VideoCameraIcon },
      { href: '/lecturer/materials', label: 'Materials', icon: DocumentTextIcon },
      { href: '/lecturer/venues', label: 'Venues', icon: MapPinIcon },
      { href: '/lecturer/events', label: 'Events', icon: CalendarIcon },
  ...
  admin: {
    ...
    navItems: [
      ...
      { href: '/admin/meetings', label: 'Live Classes', icon: VideoCameraIcon },
      { href: '/admin/lectures', label: 'Class Records', icon: VideoCameraIcon },
      { href: '/admin/assignments', label: 'Assignments', icon: DocumentTextIcon },
      { href: '/admin/exams', label: 'Exams', icon: ClipboardDocumentListIcon },
      { href: '/admin/tests', label: 'Tests', icon: ClipboardDocumentListIcon },
      { href: '/admin/announcements', label: 'Announcements', icon: MegaphoneIcon },
      { href: '/admin/events', label: 'Events', icon: CalendarIcon },
      { href: '/admin/venues', label: 'Venues', icon: MapPinIcon },
      { href: '/admin/materials', label: 'Materials', icon: DocumentTextIcon },
